...
export const LMT = defineStock({
  ...
  strategicNarrative:
    ...
    "At $534, the setup is more attractive: $6.2B FCF at 8.5% margin, 32% base-case upside to $705, and WACC of just 7.1% (beta 0.52) — one of the strongest structural discount-rate advantages in the defense sector. Unlike KRMN or speculative defense names, valuation is anchored in decades of entrenched government relationships and a backlog that stretches years forward. Pristine Burry profile (SBC 9% of NI, buybacks exceed SBC).",
  ...
  desc: [
    ...
    'NATO spending and Indo-Pacific buildup sustain 5% revenue CAGR. Missile defense, hypersonics, and classified programs add durable growth vectors. FCF margins expand from 8.5% to 10% on operating leverage. Multiple holds at 18×. Base target ~$705.',
    'Defense budget acceleration and prime contract consolidation drives 8% CAGR. Hypersonics, next-gen interceptors, and multi-domain classified programs push FCF margins to 12%. Multiple expands to 19×. Bull target ~$910.',
  ],
